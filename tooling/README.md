...
|--------|-----------------|
| [harnesses/](harnesses/) | Full agentic harnesses that run the agent loop — Claude Code, OpenCode, Codex. **Harness-specific material (hooks, skills, settings, subagents) lives under its harness**, e.g. [harnesses/claude-code/](harnesses/claude-code/). |
